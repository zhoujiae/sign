...
class CosmosKeypair {
    ...
    static toV3KeyStore(privateKey, password) {
        ...
        var acc = this.import(privateKey);
        return {
            version: 3,
            id: uuid.v4({
    ...
    static fromV3KeyStore(v3Keystore, password) {
        var nonStrict = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        if (!password) {
            throw new Error('No password given.');
        }
        var json = typeof v3Keystore === 'object' ? v3Keystore : JSON.parse(nonStrict ? v3Keystore.toLowerCase() : v3Keystore);
        if (json.version !== 3) {
