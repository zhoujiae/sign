...
describe('cosmos traction test', function() {
    ...
    let memo = '';
    let privateKey = '';
    let chain = Webc.config.chain.cosmos;
    ...
    it('test  transfer', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.transfer.type,
            return_type: 'block',
            msg: {
    ...
    it('test delegate', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.delegate.type,
            msg: {
    ...
    it('test undelegate', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.undelegate.type,
            msg: {
                validator_addr: 'cosmosvaloper1qksw0e05eh652yy0zqd7f0e3q4082dxy9qxdx6',
                shares_amount: '1.05'
            }
    ...
    it('test beginRedelegate', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.beginRedelegate.type,
            msg: {
    ...
    it('test MsgSetWithdrawAddress', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.setWithdrawAddress.type,
            msg: {
    ...
    it('test MsgWithdrawDelegatorReward', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.withdrawDelegatorReward.type,
            msg: {
                validator_addr: 'cosmosvaloper1qksw0e05eh652yy0zqd7f0e3q4082dxy9qxdx6'
            }
        };
    ...
    it('test MsgWithdrawValidatorCommission', function() {
        let tx = {
            ...
            gas: gas,
            memo: memo,
            type: Webc.config.cosmos.tx.withdrawValidatorCommission.type,
            msg: {
                validator_addr: 'cosmosvaloper1qksw0e05eh652yy0zqd7f0e3q4082dxy9qxdx6'
            }
        };
    ...
    function execute(tx) {
        let builder = Webc.getBuilder(chain);
